...
**[🌐 Project Page](https://savinay95n.github.io/SAMIC/)** &nbsp;|&nbsp; **[Paper (PDF)](https://arxiv.org/pdf/2412.11998)** &nbsp;|&nbsp; **[arXiv](https://arxiv.org/abs/2412.11998)**
...
The interactive project page (SamIC overview, SamBox annotation tool, demo videos, and qualitative results) is deployed via GitHub Pages:

**https://savinay95n.github.io/SAMIC/**

To enable Pages: repo **Settings → Pages → Deploy from branch → `main` / `/ (root)`**.
